...
import torch
from query_strategies import RandomSampling, LeastConfidence, MarginSampling, \
    EntropySampling, LeastConfidenceDropout, MarginSamplingDropout, \
    EntropySamplingDropout, KMeansSampling, KCenterGreedy, BALDDropout, \
